...
/** 
 * DAO for table "BEON_DAO".
*/
public class BeonDaoDao extends AbstractDao<BeonDao, Void> {

    public static final String TABLENAME = "BEON_DAO";

    /**
     * Properties of entity BeonDao.<br/>
    ...
    public BeonDaoDao(DaoConfig config) {
        super(config);
    }
    
    public BeonDaoDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"BEON_DAO\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"BEON_DAO\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, BeonDao entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, BeonDao entity) {
        stmt.clearBindings();
        stmt.bindLong(1, entity.getFollowMovie());
        stmt.bindLong(2, entity.getId());
    ...
    @Override
    public BeonDao readEntity(Cursor cursor, int offset) {
        BeonDao entity = new BeonDao( //
    ...
    @Override
    public void readEntity(Cursor cursor, BeonDao entity, int offset) {
    ...
    @Override
    protected final Void updateKeyAfterInsert(BeonDao entity, long rowId) {
        // Unsupported or missing PK type
        return null;
    }
    
    @Override
    public Void getKey(BeonDao entity) {
        return null;
    }

    @Override
    public boolean hasKey(BeonDao entity) {
        // TODO
        return false;
    }
