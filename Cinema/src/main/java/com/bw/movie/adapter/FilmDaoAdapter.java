 ...
 */
public class FilmDaoAdapter extends RecyclerView.Adapter<FilmDaoAdapter.ViewHolder> implements View.OnClickListener {
    FilmFragment filmFragment;
    List<BeonDao> list;


    public FilmDaoAdapter(FilmFragment filmFragment, List<BeonDao> list) {
