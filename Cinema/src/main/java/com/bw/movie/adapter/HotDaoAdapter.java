 ...
 */
public class HotDaoAdapter extends RecyclerView.Adapter<HotDaoAdapter.holder> {
    List<PopularMovieDao> list;
    Context context;


    public HotDaoAdapter(List<PopularMovieDao> list, Context context) {
