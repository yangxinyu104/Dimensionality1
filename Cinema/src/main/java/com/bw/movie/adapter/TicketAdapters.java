 ...
 */
public class TicketAdapters extends RecyclerView.Adapter<TicketAdapters.holder> {
    List<ScheduleBean.ResultBean> list;
    Context context;


    public TicketAdapters(List<ScheduleBean.ResultBean> list, BuyTicketActivity context) {
    ...
    public holder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = View.inflate(context, R.layout.ticket_items, null);
    ...
    public class holder extends RecyclerView.ViewHolder {
        @BindView(R.id.ticket_item_names)
        TextView ticketItemName;
        @BindView(R.id.ticket_item_startTimes)
        TextView ticketItemStartTime;
        @BindView(R.id.ticket_item_endTimes)
        TextView ticketItemEndTime;
        @BindView(R.id.ticket_item_prices)
