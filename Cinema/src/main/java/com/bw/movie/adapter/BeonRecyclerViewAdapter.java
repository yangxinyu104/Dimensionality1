 ...
 */
public class BeonRecyclerViewAdapter extends RecyclerView.Adapter<BeonRecyclerViewAdapter.holder> {
    List<BeonBean.ResultBean> list;
    Context context;

    public BeonRecyclerViewAdapter(List<BeonBean.ResultBean> list, Context context) {
