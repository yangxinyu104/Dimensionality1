 ...
 */
public class ShowingRecyclerViewAdapter extends RecyclerView.Adapter<ShowingRecyclerViewAdapter.holder> {
    List<ShowingBean.ResultBean> list;
    Context context;



    public ShowingRecyclerViewAdapter(List<ShowingBean.ResultBean> list, Context context) {
